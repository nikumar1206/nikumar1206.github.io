...
const Project = ({ project }: { project: ProjectData }) => {
	...
	return (
		<article className="revealz w-[325px] h-[420px] bg-transparent cursor-pointer group perspective">
			<div
			...
			>
				<div className="absolute backface-hidden w-[325px] h-full project flex flex-col">
					...
					<div
						onClick={flipCard}
						className="absolute bottom-0 right-0 mr-2 mb-2 bg-[#fefefe] rounded-full w-9 h-9 flex items-center justify-center"
					>
						<Tb360 />
					</div>
				</div>
